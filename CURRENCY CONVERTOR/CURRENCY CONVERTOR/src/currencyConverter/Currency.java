	...
	public void defaultValues() {
		...
		switch (currency) {	
			case "US Dollar":
				...
				this.exchangeValues.put("INR", 82.70);
			...
			case "Euro":
				...
				this.exchangeValues.put("INR", 88.35);
			...
			case "British Pound":
				...
				this.exchangeValues.put("INR", 102.31);
			...
			case "Swiss Franc":
				...
				this.exchangeValues.put("INR", 90.78);
			...
			case "Indian Rupee":
				...
				this.exchangeValues.put("JPY", 1.69);
				break;
			case "Japanese Yen":
				this.exchangeValues.put("USD", 0.0071);
				this.exchangeValues.put("EUR", 0.0067);
				this.exchangeValues.put("GBP", 0.0058);
				this.exchangeValues.put("CHF", 0.0065);
